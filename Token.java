public class Token {
    ...
    public static final Token QueueTok = new Token(TokenType.Queue, "queue");
    public static final Token ListTok = new Token(TokenType.List, "list");
    public static final Token DequeTok = new Token(TokenType.Deque, "deque");
    public static final Token Push_FrontTok = new Token(TokenType.Push_Front, "push_front");
    public static final Token Push_BackTok = new Token(TokenType.Push_Back, "push_back");
    public static final Token Pop_FrontTok = new Token(TokenType.Pop_Front, "pop_front");
    public static final Token Pop_BackTok = new Token(TokenType.Pop_Back, "pop_back");
    public static final Token ReadTok = new Token(TokenType.Read, "read");
    public static final Token WriteTok = new Token(TokenType.Write, "write");
    ...
    public static Token mkBoolLiteral (String name){
